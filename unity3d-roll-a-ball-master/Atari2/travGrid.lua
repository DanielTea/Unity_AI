...
--create ball objects
  self.ball.x = math.random(3,self.size-3)
  self.ball.y = math.random(3, self.size-3)
  
  self.ball1.x = math.random(3, self.size-3)
  self.ball1.y = math.random(3, self.size-3)
  
  self.ball2.x = math.random(3, self.size-3)
  self.ball2.y = math.random(3, self.size-3)
