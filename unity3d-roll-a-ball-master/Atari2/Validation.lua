...
-- Daniel reduce race condition set new game flag
  	...
  	file = io.open('/media/daniel/BigNeuronalNetwo/NewTests/unity3d-roll-a-ball-master/networkSWSem.txt','w')
	   ...
	   file:close()
        ...
        os.remove('/media/daniel/BigNeuronalNetwo/NewTests/unity3d-roll-a-ball-masters/networkSWSem.txt')
...
log.info(reward)
  ...
  log.info('Final Score: ' .. episodeScore .. ' out of 100 Episodes')
