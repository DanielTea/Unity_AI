...
if [ "$PAPER" == "daniel" ]; then
  # Catch demo
  qlua main.lua -env rollaball - gpu 1 -hiddenSize 48 -optimiser adam  -steps 3000000 -learnStart 80000 -memSize 1000000 -	epsilonSteps 30000 -valFreq 15000 -valSteps 10000 -bootstraps 0 -memPriority rank -PALpha 0 -duel true -verbose true -PALpha 0 -alpha 0.5 -betaZero 0.5 -eta 0.0000225"$@"
  ...
  qlua main.lua -gpu 1 -env rlenvs.Atari -game $GAME -height 84 -width 84 -colorSpace y -bootstraps 0 -PALpha 0 -eta 0.00025 -steps 30000000
  -duel true -verbose true
  "$@"
  ...
  th main.lua -env rlenvs.Atari -game $GAME -height 84 -width 84 -colorSpace y -bootstraps 0 -memPriority rank -alpha 0.7 -betaZero 0.5 -PALpha 0 -memSize 100000"$@"
