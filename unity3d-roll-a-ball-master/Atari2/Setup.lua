...
function Setup:parseOptions(arg)
  ...
  cmd:option('-memSize', 1e3, 'Experience replay memory size (number of tuples)')
  ...
  cmd:option('-steps', 500000, 'Training iterations (steps)') -- Frame := step in ALE; Time step := consecutive frames treated atomically by the agent
